...
PYTHONPATH=analysis python analysis/continuous_onset_dynamics.py --data-root "$DATA_ROOT" --out "$OUT_ROOT/continuous" --nperm 199
PYTHONPATH=analysis python analysis/antecedent_history_final_v2.py --data-root "$DATA_ROOT" --out "$OUT_ROOT/antecedent" --nperm 499
